...
Процедура СоздатьНоменклатуруИнформационнойБазы(Знач НаборЭлементовСопоставления)
	...
	ПараметрыОбработки.Вставить("ТипыНоменклатуры", Элементы.СопоставлениеНоменклатура.ОграничениеТипа.Типы());
	ПараметрыОбработки.Вставить("ПараметрыСозданияНоменклатуры", ДополнительныеПараметрыПоиска);
...
Процедура ДобавитьДействиеСПравиломПоиска(СписокДействий, ЭлементСопоставления)
	...
	Если ТекущееДействие = Неопределено Тогда
		Возврат;
	ИначеЕсли ТекущееДействие = "ДобавитьПравилоПоиска" Тогда
...
&НаКлиенте
Процедура ОткрытьФормуПравилаПоиска()
	...
	Если ПустаяСтрока(ТекущиеДанные.ХешПоисковойСтроки) Тогда
