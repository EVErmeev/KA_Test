...
Процедура ЗафиксироватьРезультатПроверкиИПодбора(Параметры, АдресРезультата) Экспорт
	...
	ЗаполнитьСпецификуСрокиГодности = ТипЗнч(Параметры.ПроверяемыйДокумент) = Тип("ДокументСсылка.МаркировкаТоваровИСМП")
		И (ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(Параметры.ВидМаркируемойПродукции)
			...
			Или Параметры.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.Пиво
			Или Параметры.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.БезалкогольноеПиво
			Или Параметры.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.УпакованнаяВода);
...
Процедура ЗаполнитьТаблицуПодобраннойМаркируемойПродукции(ТаблицаМаркируемойПродукции, ДанныеДокумента, СвойстваВидаПродукции)
	...
	Иначе
		...
		Если ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(ДанныеДокумента.ВидМаркируемойПродукции)
				Или ДанныеДокумента.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.БАДы
				Или ДанныеДокумента.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.Пиво
				Или ДанныеДокумента.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.БезалкогольноеПиво
				Или ДанныеДокумента.ВидМаркируемойПродукции = Перечисления.ВидыПродукцииИС.УпакованнаяВода Тогда
