...
Процедура ПодгтовитьКВыгрузкеРекурсивно(Узлы, ТекстПодчиненныхЗаполнен, ТребуетсяВыгрузитьПодчиненные)
	Для Каждого Узел Из Узлы Цикл
		...
		ПодгтовитьКВыгрузкеРекурсивно(Узел.Строки, Узел.ТекстПодчиненныхЗаполнен, Узел.ТребуетсяВыгрузитьПодчиненные);
		...
		Если МожетБытьНеопределено И Узел.Текст = Неопределено И Не Узел.ТекстПодчиненныхЗаполнен Тогда
...
Функция ТребуетсяВыгрузитьУзел(Узел)
	Возврат Не Узел.МожетОтсутствовать
		Или Узел.ТекстЗаполнен
		Или Узел.ТекстПодчиненныхЗаполнен;
КонецФункции
