...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыполненоПодключение = ВыполненоПодключение(); // СервисПрогнозирования.
...
Процедура Подключаемый_ОбновитьПрогнозНаСервере(ВыполнениеПроверено = Ложь)
	Если ВыполнениеПроверено
		Или ДлительныеОперации.ЗаданиеВыполнено(ИдентификаторЗаданияОбновитьПрогноз) Тогда
...
Процедура Подключаемый_ЗагрузитьПрогнозНаСервере(ВыполнениеПроверено = Ложь)
	Если ВыполнениеПроверено
		Или ДлительныеОперации.ЗаданиеВыполнено(ИдентификаторЗаданияЗагрузитьПрогноз) Тогда
...
Процедура ОбновитьКомандыВыбораВариантов()
	...
	Для Каждого СтрокаТаблицы Из ТаблицаВариантов Цикл
		...
		КонецЕсли;
		// Сервис прогнозирования.
		Если ЭтоНедоступныйВариантОтчета(СтрокаТаблицы.КлючВарианта) Тогда
			Продолжить;
		КонецЕсли;
