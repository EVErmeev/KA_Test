...
Процедура ЗаполнитьНастройкиПодключенияИзXML(НастройкиПодключения,
	...
	ПланОбменаРаспознан = Ложь;
	ИмяПланаОбменаВНастройках = "";
	РаспознатьИмяПланаОбменаИзНастроек(НастройкиПодключения, СтруктураНастроек, ПланОбменаРаспознан);
	
	Если Не ПланОбменаРаспознан Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура РаспознатьИмяПланаОбменаИзНастроек(НастройкиПодключения, СтруктураНастроек, ПланОбменаРаспознан)
	
	ИмяПланаОбменаВНастройках = "";
	СтруктураНастроек.Свойство("ИмяПланаОбмена", ИмяПланаОбменаВНастройках);
	
	Если НЕ ПустаяСтрока(ИмяПланаОбменаВНастройках) Тогда
		
		Если ИмяПланаОбменаВНастройках = НастройкиПодключения.ИмяПланаОбмена Тогда 
			
			ПланОбменаРаспознан = Истина;
			
		ИначеЕсли ОбменДаннымиТрансляцияФорматаПовтИсп.ТранслироватьИмя(ИмяПланаОбменаВНастройках, "en") = НастройкиПодключения.ИмяПланаОбмена Тогда
	...
	Если НЕ ПланОбменаРаспознан Тогда
		...
		ВариантНастройки = НастройкиПодключения.ВариантНастройкиОбмена;
		ОбменДаннымиПереопределяемый.ПриПроверкеКорректностиИмениПланаОбменаEnterpriseData(ИмяПланаОбменаВНастройках, ВариантНастройки, ПланОбменаРаспознан);
		
		Если НЕ ПланОбменаРаспознан
			И ОбменДаннымиПовтИсп.ЭтоПланОбменаXDTO(НастройкиПодключения.ИмяПланаОбмена) Тогда
