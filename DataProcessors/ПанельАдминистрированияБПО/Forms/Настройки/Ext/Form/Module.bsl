...
Процедура УстановитьВидимостьРазделов()
	...
	Иначе
		Элементы.ГруппаУправлениеОбменомСПодключаемымОборудованием.Видимость = Ложь;
	КонецЕсли;
	...
	Если МенеджерОборудованияВызовСервера.ИспользуетсяЭлектронныеСертификатыНСПК() Тогда
		МодульЭлектронныеСертификаты = ОбщегоНазначения.ОбщийМодуль("ЭлектронныеСертификаты");
