...
// * Прораз - Строка - протокол разногласий, позволяющий выразить возражения и согласовать условия договора, по которым
// 		у сторон есть разногласия (пункт 1 ст. 445 ГК РФ)
...
// 		которое достаточно определенно выражает намерение лица, сделавшего предложение, считать себя заключившим договор с
// 		адресатом, которым будет принято предложение (ст. 435 ГК РФ)
