...
Функция ПодготовленныйРеглОтчет(ИмяФормы, ПараметрыАвтоформирования, КорректирующийОтчет)
	...
	//РазделыОтчета.Титульный.Период      = Формат(Месяц(ПараметрыАвтоформирования.ДатаОкончания), "ЧЦ=2; ЧВН=");
...
Функция ПроверитьВозможностьВыгрузки(ИмяФормы,
	...
	Иначе
		...
		//
		Возм_СтатусыЗЛ = ВозможныеЗначенияИзСпискаВыбораПоказателя("СтатусыЗЛ");
		Возм_Дни       = ВозможныеЗначенияИзСпискаВыбораПоказателя("Дни");
		Возм_Месяцы    = ВозможныеЗначенияИзСпискаВыбораПоказателя("Месяцы");
		Возм_КТО       = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыТипаОрганизации");
		Возм_ТипыСвед  = ВозможныеЗначенияИзСпискаВыбораПоказателя("ТипыСведений");
		Возм_КодыДолжн = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыДолжности");
		Возм_КатегПерс = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыКатегорийПерсонала");
		Возм_ВидыДог   = ВозможныеЗначенияИзСпискаВыбораПоказателя("ВидыДоговора");
		Возм_СрокиДог  = ВозможныеЗначенияИзСпискаВыбораПоказателя("СрокиДоговора");
		Возм_УченСтеп  = ВозможныеЗначенияИзСпискаВыбораПоказателя("УченыеСтепени");
		Возм_УченЗван  = ВозможныеЗначенияИзСпискаВыбораПоказателя("УченыеЗвания");
		Возм_ПочетЗван = ВозможныеЗначенияИзСпискаВыбораПоказателя("ПочетныеЗвания");
		Возм_ПрофКвГр  = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыПрофКвалифГруппы");
		Возм_КвалифУр  = ВозможныеЗначенияИзСпискаВыбораПоказателя("КвалифУровни");
		Возм_СпОцУслТр = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыСпецОценкиУслТруда");
		Возм_КвалКатАт = ВозможныеЗначенияИзСпискаВыбораПоказателя("КвалифКатегПоИтАттестации");
		Возм_СистОплТр = ВозможныеЗначенияИзСпискаВыбораПоказателя("СистемаОплатыТруда");
		Возм_КодыУслЗ  = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыУсловийЗанятости");
		Возм_ЗнКодУслЗ = ВозможныеЗначенияИзСпискаВыбораПоказателя("ЗначенияКодаУсловийЗанятости");
		Возм_КодыСпЧР  = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыСпецЧасовРаботы");
		Возм_КодыВыпл  = ВозможныеЗначенияИзСпискаВыбораПоказателя("КодыВыплат");
						...
						Для каждого СтрокаМнЧ_3 Из ДеревоМнЧ_3.Строки Цикл
							...
							Иначе
								Если СтрРазделить("0,ВМП,УОМП,ПС,ФМП,РМБ,РСМП,ФАП", ",", Ложь).Найти(КодУЗ) <> Неопределено Тогда
									Возм_Зн = ВозможныеЗначенияИзСпискаВыбораПоказателя("ЗначенияКода" + КодУЗ);
