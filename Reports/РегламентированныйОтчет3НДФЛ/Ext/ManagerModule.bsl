...
Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	...
	Если ВыбраннаяФорма = "ФормаОтчета2023кв1"
		Или ВыбраннаяФорма = "ФормаОтчета2022кв1"
		...
		УплаченныеАвансы = 0;
		Если ВыбраннаяФорма = "ФормаОтчета2023кв1" Или ВыбраннаяФорма = "ФормаОтчета2022кв1" Тогда
		...
		Для Каждого СтрокаДекларации Из ДанныеДекларации Цикл
			...
			Если ВыбраннаяФорма = "ФормаОтчета2023кв1"
				Или ВыбраннаяФорма = "ФормаОтчета2022кв1"
				Или ВыбраннаяФорма = "ФормаОтчета2021кв1" Тогда
...
Функция ИмяФайлаСхемы(ВыбраннаяФорма, ДатаПодписи)
	...
	Если ВыбраннаяФорма = РеквизитыФормы2023().ИмяОбъекта Тогда
...
Функция ИмяМакетаДереваВыгрузкиXML(ВыбраннаяФорма)
	...
	Если ВыбраннаяФорма = РеквизитыФормыОтчета2023().ФормаОтчета Тогда
...
Функция СтруктураРеквизитовФормы(Организация, Период, ВыбраннаяФорма, ПараметрыОткрытойФормы = Неопределено) Экспорт
	...
	Если ПараметрыФормы.мВыбраннаяФорма = РеквизитыФормы2023().ИмяОбъекта Тогда
...
Функция НалоговыеСтавки(ВыбраннаяФорма) Экспорт
	...
	Если ВыбраннаяФорма = РеквизитыФормыОтчета2023().ФормаОтчета
		Или ВыбраннаяФорма = РеквизитыФормыОтчета2022().ФормаОтчета Тогда
...
Функция КодыВидовПредпринимательскойДеятельности(ВыбраннаяФорма) Экспорт
	...
	Если ВыбраннаяФорма = РеквизитыФормыОтчета2023().ФормаОтчета
		Или ВыбраннаяФорма = РеквизитыФормыОтчета2022().ФормаОтчета
