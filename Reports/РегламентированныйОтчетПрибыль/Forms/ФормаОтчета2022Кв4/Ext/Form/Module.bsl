...
Процедура СформироватьСлужебныеДанные()
	...
	ПредставленияРазделов.Вставить("Р13", "Раздела 1.3");
...
Процедура СформироватьПриоритетыРазделов()
	...
	ПриоритетыРазделов.Добавить("Раздел 1.3");
...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к доплате в федеральный бюджет в стр.040 Раздела 1.1 = стр.270 - стр.280 '") +
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.1");
	...
	НастройкиКС.Вставить("ПоказательР11"	, "П00011М104003_");
	НастройкиКС.Вставить("ПоказательЛ21"	, "П000020027003");
	НастройкиКС.Вставить("ПоказательЛ22"	, "П000020028003");
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уменьшению в федеральный бюджет в стр.050 Раздела 1.1 = стр.280 - стр.270 '") +
		НСтр("ru='Листа 02 с кодами 01, 03, 04 по реквизиту ""Признак налогоплательщика""'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.050 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1-3 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ПоказательР11"	, "П00011М105003_");
	НастройкиКС.Вставить("ПоказательЛ21"	, "П000020028003");
	НастройкиКС.Вставить("ПоказательЛ22"	, "П000020027003");
...
Процедура ПроверкаКС_1_02_код()
	...
	ИменаПоказателей.Вставить("Л02С002"		, НастройкиКС.ПоказательЛ21);
	ИменаПоказателей.Вставить("Л02С003"		, НастройкиКС.ПоказательЛ22);
	...
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р11С001.Итог, РасчетнаяСумма, Показатели.Л02С002.Итог, -Показатели.Л02С003.Итог);
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к доплате в бюджет субъекта РФ в стр.070 Раздела 1.1 = стр.271 - стр.281 '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.070 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1-3 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ПоказательЛ21"	, "П000020027103");
	НастройкиКС.Вставить("ПоказательЛ22"	, "П000020028103");
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к доплате в бюджет субъекта РФ в стр.070 Раздела 1.1 = стр.100 - стр.110 Приложения '") +
		...
		НСтр("ru='Приложение 5 к Листу 02), или стр.070 Раздела 1.1 = стр.100 - стр.110 Приложения 5 к Листу 02 '") +
		НСтр("ru='с кодами 01, 03, 06, 14 по реквизиту ""Признак налогоплательщика"" и кодом 4 по реквизиту'") +
		НСтр("ru=' ""Расчет составлен"", для организаций, имеющих обособленные подразделения (заполнено Приложение 5 к '") +
		НСтр("ru='Листу 02), если КПП Приложения 5 к Листу 02 = КПП Титульного листа, иначе стр.070 Раздела 1.1 = 0'"));
...
Процедура ПроверкаКС_1_05()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уменьшению из бюджета субъекта РФ в стр.080 Раздела 1.1 = стр.281 - стр.271 '") +
		НСтр("ru='Листа 02 с кодами 01, 03, 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"", для организаций, '") +
		НСтр("ru='не имеющих обособленных подразделений (не заполнено Приложение 5 к Листу 02)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.080 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1-3 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.Вставить("ПоказательЛ21"	, "П000020028103");
	НастройкиКС.Вставить("ПоказательЛ22"	, "П000020027103");
...
Процедура ПроверкаКС_1_06()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уменьшению из бюджета субъекта РФ в стр.080 Раздела 1.1 = стр.110 - стр.100 '") +
		...
		НСтр("ru='Приложение 5 к Листу 02), или стр.080 Раздела 1.1 = стр.110 - стр.100 '") +
		НСтр("ru='Приложения 5 к Листу 02 с кодами 01, 03, 06, 14 по реквизиту ""Признак налогоплательщика"" и кодом 4 '") +
		НСтр("ru='по реквизиту ""Расчет составлен"", для организаций, имеющих обособленные подразделения (заполнено '") +
		НСтр("ru='Приложение 5 к Листу 02), если КПП Приложения 5 к Листу 02 = КПП Титульного листа, иначе стр.080 '") +
...
Процедура ПроверкаКС_1_06_код()
	...
	Показатели.П25С007.Инверсия = Истина;
	ЗарегистрироватьПроверку();
	Код_ПН_Найден = Ложь;
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_5 Из Лист02.Лист02_5 Цикл
			...
			ИначеЕсли Показатели.П25С002.Значение = "4" И ДанныеКС.КПП = Показатели.П25С003.Значение Тогда
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.РазделЗаполнен_Раздел1_1 И Код_ПН_Найден 
		И ДанныеКС.ЭтоГоловнаяСОП И НЕ (Показатели.Р11С001.Итог = РасчетнаяСумма1 
		ИЛИ Показатели.Р11С001.Итог = РасчетнаяСумма2);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р11С001.Итог, РасчетнаяСумма1, Показатели.П25С004.Итог, -Показатели.П25С005.Итог,
...
Процедура ПроверкаКС_2_01()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к доплате в федеральный бюджет в стр.040 Раздела 1.1 >= 0'"));
...
Процедура ПроверкаКС_2_02()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уменьшению в федеральный бюджет в стр.050 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.050 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_03()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к доплате в бюджет субъекта РФ в стр.070 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.070 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_04()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уменьшению из бюджета субъекта РФ в стр.080 Раздела 1.1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.080 Раздела 1.1");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_1_07()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.120 Раздела 1.2 = (стр.300 Листа 02 с кодами 01, 03, 04 '") +
		НСтр("ru='по реквизиту ""Признак налогоплательщика"") / 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %3 (%2 / 3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.120 Раздела 1.2");
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.130 Раздела 1.2 = (стр.300 Листа 02 с кодами 01, 03, 04 '") +
		НСтр("ru='по реквизиту ""Признак налогоплательщика"") / 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %3 (%2 / 3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.130 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.140 Раздела 1.2 = стр.300 Листа 02 с кодами 01, 03, 04 '") +
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.140 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	ПроверкаКС_1_07_2_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_07_1_код()
	...
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р12С002.Итог, Показатели.Л02С002.Итог, РасчетнаяСумма);
	ДополнитьТаблицуРезультата();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_07_2_код()
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.РазделЗаполнен_Раздел1_2 
		...
		И КодКварталаНайден И ДанныеКС.ЭтоГоловная И НЕ Показатели.Р12С002.Итог = РасчетнаяСумма;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р12С002.Итог, Показатели.Л02С002.Итог, -Показатели.Р12С003.Итог, -Показатели.Р12С004.Итог, 
		РасчетнаяСумма);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Код квартала, на который начисляются авансовые платежи в стр.001 Раздела 1.2 = '") +
	...
	Заголовки.Вставить("Рекомендации"		, "Укажите код квартала в стр.001 Раздела 1.2 = 21 или 24");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.Периодичность = 3 И ДанныеКС.ОтчетЗаКвартал И ДанныеКС.МесОтчета = 9 
...
Процедура ПроверкаКС_1_09()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансовых платежей в стр.120, 130, 140 Раздела 1.2 = стр.330 Листа 02 с кодами '") +
	...
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансовых платежей в стр.120, 130, 140 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.220 Раздела 1.2 = (стр.310 Листа 02 с кодами 01, 03, 06, 07, 08, '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %3 (%2 / 3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.220 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.230 Раздела 1.2 = (стр.310 Листа 02 с кодами 01, 03, 06, 07, 08, '") +
		НСтр("ru='14 по реквизиту ""Признак налогоплательщика"") / 3 для организаций, не имеющих обособленные '") +
		НСтр("ru='подразделения (не заполнено Приложение 5 к Листу 02)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %3 (%2 / 3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.230 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.240 Раздела 1.2 = стр.310 Листа 02 с кодами 01, 03, 06, 07, 08, '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %5 (%2 - %3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.240 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_11()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансовых платежей в стр.220, 230, 240 Раздела 1.2 = стр.310 Листа 02 с кодами '") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%4 (%1 + %2 + %3) = %5'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансовых платежей в стр.220, 230, 240 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_12()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансовых платежей в стр.220, 230, 240 Раздела 1.2 = стр.340 Листа 02 с кодами '") +
...
Процедура ПроверкаКС_1_13()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.220 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
		НСтр("ru=' 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"" и кодом 1 по реквизиту ""Расчет составлен""'") +
		НСтр("ru=') / 3, для организаций, имеющих обособленные подразделения (заполнено Приложение 5 к Листу 02) или '") +
		НСтр("ru='сумма авансового платежа в стр.220 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %3 (%2 / 3) или %1 = %5 (%4 / 3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.220 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
...
Процедура ПроверкаКС_1_14()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.230 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
		НСтр("ru=' 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"" и кодом 1 по реквизиту ""Расчет составлен""'") +
		НСтр("ru=') / 3, для организаций, имеющих обособленные подразделения (заполнено Приложение 5 к Листу 02) или '") +
		НСтр("ru='сумма авансового платежа в стр.230 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
		НСтр("ru=' 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"" и кодом 4 по реквизиту ""Расчет составлен""'") +
...
Процедура ПроверкаКС_1_14_код()
	...
	РасчетнаяСумма1 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, 
		Показатели.П25С004.Итог / 3);
	РасчетнаяСумма2 = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, 
		Показатели.П25С005.Итог / 3);
		
	НастройкиКС.ЭтоОшибка = ДанныеКС.РазделЗаполнен_Раздел1_2 И Код_ПН_Найден 
		И КодКварталаНайден И ДанныеКС.ЭтоГоловнаяСОП 
		И НЕ (Показатели.Р12С002.Итог = РасчетнаяСумма1 ИЛИ Показатели.Р12С002.Итог = РасчетнаяСумма2);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р12С002.Итог, Показатели.П25С004.Итог, РасчетнаяСумма1, Показатели.П25С005.Итог, РасчетнаяСумма2);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансового платежа в стр.240 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
		НСтр("ru=' 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"" и кодом 1 по реквизиту ""Расчет составлен""'") +
		НСтр("ru=') - стр.220 - стр.230 Раздела 1.2, для организаций, имеющих обособленные подразделения (заполнено '") +
		НСтр("ru='Приложение 5 к Листу 02) или '") +
		НСтр("ru='сумма авансового платежа в стр.240 Раздела 1.2 = (стр.120 Приложения 5 к Листу 02 с кодами 01, 03,'") +
		НСтр("ru=' 06, 07, 08, 14 по реквизиту ""Признак налогоплательщика"" и кодом 4 по реквизиту ""Расчет составлен""'") +
		НСтр("ru=') - стр.220 - стр.230 Раздела 1.2, для организаций, имеющих обособленные подразделения (заполнено '") +
...
Процедура ПроверкаКС_1_16()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма авансовых платежей в стр.220, 230, 240 Раздела 1.2 = стр.121 Приложения 5 к '") +
		...
		НСтр("ru='подразделения (заполнено Приложение 5 к Листу 02) или '") +
		НСтр("ru='сумма авансовых платежей в стр.220, 230, 240 Раздела 1.2 = стр.121 Приложения 5 к '") +
...
Процедура ПроверкаКС_1_16_код()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_5 Из Лист02.Лист02_5 Цикл
			...
			ИначеЕсли ПоказателиЛ2.П25С002.Значение = "4" И ДанныеКС.КПП = ПоказателиЛ2.П25С003.Значение Тогда
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.Периодичность = 3 И ДанныеКС.ОтчетЗаКвартал И ДанныеКС.МесОтчета = 9 
		И ДанныеКС.РазделЗаполнен_Раздел1_2 
		И Код_ПН_Найден И КодКварталаНайден И ДанныеКС.ЭтоГоловнаяСОП 
...
Процедура ПроверкаКС_1_17_1()
	...
	Заголовки.Вставить("Рекомендации"		, 
		"Укажите сумму авансовых платежей стр.120, 130, 140, 220, 230, 240 Раздела 1.2 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_17_2_доп()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный код квартала'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите пустое значение в стр.001 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_05()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.120 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.120 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_06()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.130 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.130 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_07()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.140 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.140 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_08()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.220 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.220 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_09()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.230 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.230 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_10()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма авансового платежа в стр.240 Раздела 1.2 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансового платежа'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансового платежа в стр.240 Раздела 1.2");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_1_18()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 = стр.120 Листа 03 (Раздел А), если код вида '") +
		НСтр("ru='платежа в стр.010 Раздела 1.3 = 1'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.3");
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1_3.КолвоСтрокП00013М1 Цикл
		...
		Для Счетчик2 = 1 По ДанныеКС.Раздел1_3["КолвоСтрокП00013М2_" + Счетчик] Цикл
			ЗаполнитьИРасшифроватьПоказатель(Показатели.Р13П002, ДанныеКС.Раздел1_3, "" + Счетчик + "_" + Счетчик2);
		КонецЦикла;
	...
	НастройкиКС.ЭтоОшибка = ДанныеКС.РазделЗаполнен_Раздел1_3 И КодР13Найден 
		И НЕ Показатели.Р13П002.Итог = Показатели.Л3АС001.Итог;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Р13П002.Итог, Показатели.Л3АС001.Итог);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 = стр.050 Листа 03 (Раздел Б) с кодами вида дохода '") +
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 = стр.080 Листа 04 с кодами вида дохода '") +
		НСтр("ru='01, 02, если код вида платежа в стр.010 Раздела 1.3 = 3'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.3");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.281 НК РФ'"));
...
Процедура ПроверкаКС_1_21()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 = стр.080 Листа 04 с кодом вида дохода '") +
		НСтр("ru='04, если код вида платежа в стр.010 Раздела 1.3 = 4'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.3");
...
Процедура ПроверкаКС_1_22()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 = стр.080 Листа 04 с кодом вида дохода '") +
		НСтр("ru='06, если код вида платежа в стр.010 Раздела 1.3 = 5'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.3");
...
Процедура ПроверкаКС_1_22_код()
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1_3.КолвоСтрокП00013М1 Цикл
		...
		ЗаполнитьПоказатель(Показатели.Р13С001, ДанныеКС.Раздел1_3, Счетчик);
		Если НЕ Показатели.Р13С001.Значение = НастройкиКС.КодР13 Тогда
			Продолжить;
		КонецЕсли; 
	...
	Для каждого Лист04 Из ДанныеКС.Лист04 Цикл
		...
		Если НЕ КодНайден(Показатели.Л04С001.Значение, НастройкиКС.КодЛ04) Тогда
			Продолжить;
		КонецЕсли; 
...
Процедура ПроверкаКС_2_11()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма налога к уплате в стр.040 Раздела 1.3 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 Раздела 1.3");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 21.02.2023 № ЕА-4-15/2048@'"));
...
Процедура ПроверкаКС_2_11_код()
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1_3.КолвоСтрокП00013М1 Цикл
		Для Счетчик2 = 1 По ДанныеКС.Раздел1_3["КолвоСтрокП00013М2_" + Счетчик] Цикл
			...
			ЗарегистрироватьПроверку();
			ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.Раздел1_3, "" + Счетчик + "_" + Счетчик2);
...
Процедура ПроверкаКС_1_30()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма льготы в стр.090 Листа 02 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма льготы'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму льготы в стр.090 Листа 02 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена из-за отсутствия стр.090 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_32()
	...
	РасчетнаяСумма = СуммаПоказателей(Показатели, 1) - Показатели.Л02С001.Итог;
	НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И ДанныеКС.ОтчетЗаКвартал И НЕ ДанныеКС.РазделЗаполнен_Лист05 И 
		НЕ ДанныеКС.РазделЗаполнен_Лист06 И НЕ ДанныеКС.РазделЗаполнен_Лист08 И НЕ Показатели.Л02С001.Итог = РасчетнаяСумма;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Л02С001.Итог, Показатели.Л02С002.Итог, -Показатели.Л02С003.Итог, -Показатели.Л02С004.Итог, 
		Показатели.П21С001.Итог, -Показатели.П22С001.Итог, РасчетнаяСумма);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_35()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		РасчетнаяСумма = СуммаПоказателей(Показатели) - Показатели.Л02С001.Значение;
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И Показатели.Л02С002.Значение > 0 
			И НЕ Показатели.Л02С001.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
...
Процедура ПроверкаКС_1_36()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму налоговой базы в стр.120 Листа 02 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И Показатели.Л02С002.Значение = Показатели.Л02С003.Значение 
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму налоговой базы в стр.130 Листа 02 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Проверка носит справочный характер'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Ошибка по данной проверке не выдается'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_38()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяБезОП И Показатели.Л02С001.Значение = 0 
			И НЕ Показатели.Л02С002.Значение = РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Л02С002.Значение, Показатели.Л02С003.Значение, Показатели.Л02С004.Значение, РасчетнаяСумма);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Лист02.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_41()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И КодНайден(Показатели.Л02С001.Значение, "01") 
...
Процедура ПроверкаКС_1_42()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И (КодНайден(Показатели.Л02С001.Значение, "02") 
...
Процедура ПроверкаКС_1_43()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= 2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная величина ставки налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите ставку налога в стр.150 Листа 02 <= 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И КодНайден(Показатели.Л02С001.Значение, "03") 
...
Процедура ПроверкаКС_1_44()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяБезОП И КодНайден(Показатели.Л02С001.Значение, "01") И 
...
Процедура ПроверкаКС_1_45()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяБезОП И (КодНайден(Показатели.Л02С001.Значение, "02") 
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='""Признак налогоплательщика"" равен 03 (резиденты Калининградской ОЭЗ)'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= 13,5'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная величина ставки налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите ставку налога в стр.160 Листа 02 <= 13,5");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяБезОП И КодНайден(Показатели.Л02С001.Значение, "03") 
...
Процедура ПроверкаКС_1_47()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная величина ставки налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите ставку налога в стр.170 Листа 02 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Проверка носит справочный характер'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Ошибка по данной проверке не выдается'"));
...
Процедура ПроверкаКС_1_64()
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = %6 (%2 - %3 - %4 - %5), когда %2 > %7 (%3 + %4 + %5)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_65()
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = %7 (%2 - %3 - %4 - %5 - %6), когда %2 > %8 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_67()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='Листа 02 < стр.220 + стр.250 + стр.268 Листа 02'"));
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = %6 (%3 + %4 +%5 - %2), когда %2 < %7 (%3 + %4 + %5)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_68()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='когда стр.200 Листа 02 < стр.230 + стр.260 + стр.267 + стр.269 Листа 02'"));
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = %7 (%3 + %4 + %5 + %6 - %2), когда %2 < %8 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_70()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3), когда %4 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
...
Процедура ПроверкаКС_1_73()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0, %2 = 0, когда %3 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
...
Процедура ПроверкаКС_1_74()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='Листа 02 за предыдущий отчетный период < 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0, когда %4 (%2 - %3) < 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму авансовых платежей в стр.290 Листа 02 = 0");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
...
Процедура ПроверкаКС_1_76()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3), когда %5 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансовых платежей в стр.300 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_80()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловная И ДанныеКС.МесОтчета = 9 
...
Процедура ПроверкаКС_2_22()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='если (стр.220 + стр.250 + стр.268) Листа 02 > стр.190 Листа 02'"));
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		РасчетнаяСумма = Показатели.Л02С002.Значение + Показатели.Л02С003.Значение + Показатели.Л02С004.Значение 
			- Показатели.Л02С005.Значение;
		НастройкиКС.ЭтоОшибка = РасчетнаяСумма > 0 И Показатели.Л02С001.Значение > РасчетнаяСумма;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
...
Процедура ПроверкаКС_2_23()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.281 Листа 02 <= (стр.230 + стр.260 + стр.267 + стр.269 - стр.200) Листа 02, '") +
		НСтр("ru='если (стр.230 + стр.260 + стр.267 + стр.269) Листа 02 > стр.200 Листа 02'"));
...
Процедура ПроверкаКС_1_105()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма убытка в стр.010 Приложения 4 к Листу 02 = стр.160 - стр.161 Приложения 4 к Листу 02 '") +
...
&НаСервере
Процедура ПроверкаКС_1_109_код()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		Для каждого Лист02_4 Из Лист02.Лист02_4 Цикл
			...
			НастройкиКС.ЭтоОшибка = (ДанныеКС.МесОтчета = 3 ИЛИ ДанныеКС.МесОтчета = 12) И ДанныеКС.ЭтоГоловная 
				И КодНайден(Показатели.Л02С001.Значение, "01,03,04") И Показатели.П24С001.Значение = Показатели.Л02С001.Значение;
			Если НастройкиКС.НомерКС = "1.107" Тогда
...
&НаСервере
Процедура ПроверкаКС_1_110_код()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Л05С001"		, ?(НастройкиКС.НомерКС = "1.108", "П000050006003", "П000050004003"));
	ИменаПоказателей.Вставить("П24С001"		, "П000240000100");
	ИменаПоказателей.Вставить("П24С002"		, "П000240014003");
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_4 Из Лист02.Лист02_4 Цикл
			...
			Если НастройкиКС.НомерКС = "1.108" Тогда
				НастройкиКС.ЭтоОшибка = НастройкиКС.ЭтоОшибка И Показатели.Л05С001.Итог > 0 
...
Процедура ПроверкаКС_1_112()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%3 (%1 - %2) <= %4, когда %4 < %5'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма убытка'"));
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_4 Из Лист02.Лист02_4 Цикл
			...
			НастройкиКС.ЭтоОшибка = (ДанныеКС.МесОтчета = 3 ИЛИ ДанныеКС.МесОтчета = 12) И Разность > Показатели.П24С003.Значение 
...
Процедура ПроверкаКС_1_113()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0 когда %2 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма убытка'"));
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_4 Из Лист02.Лист02_4 Цикл
			...
			НастройкиКС.ЭтоОшибка = (ДанныеКС.МесОтчета = 3 ИЛИ ДанныеКС.МесОтчета = 12) И НЕ Показатели.П24С001.Значение = 0 
...
&НаСервере
Процедура ПроверкаКС_1_115_код()
	...
	Если НастройкиКС.НомерКС = "1.114" Тогда
...
Процедура ПроверкаКС_1_117()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		Для каждого Лист02_5 Из Лист02.Лист02_5 Цикл
			...
			НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяСОП И Показатели.Л02С001.Значение = Показатели.П25С001.Значение
...
Процедура ПроверкаКС_1_118()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налоговой базы в стр.031 Приложения 5 к Листу 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_120()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 100'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная доля налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните значения долей налоговых баз в стр.040 Приложений 5 к Листу 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена'"));
...
Процедура ПроверкаКС_1_126()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.080 Приложения 5 к Листу 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='Арифметическая ошибка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_131()
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = %7 (%2 - %3 - %4 - %5 - %6), когда %8 (%3 + %4 + %5 + %6) < %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
...
&НаСервере
Процедура ПроверкаКС_1_132_код()
	
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("П25С001"		, ?(НастройкиКС.НомерКС = "1.131", "П000250010003", "П000250011003"));
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		Для каждого Лист02_5 Из Лист02.Лист02_5 Цикл
			...
			Если НастройкиКС.НомерКС = "1.131" Тогда
