...
Процедура ДашбордыПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОткрытьФорму("Справочник.ДашбордыМЦП.ФормаОбъекта", , ЭтаФорма);
...
Процедура Изменить(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		ОткрытьФорму("Справочник.ДашбордыМЦП.ФормаОбъекта", Новый Структура("Ключ", ТекущиеДанные.Ссылка), ЭтаФорма);
	КонецЕсли;
...
Процедура Подключаемый_АнализВзаимосвязанныхВариантовАнализа(Команда)
	...
	ОткрытьФорму("Отчет.МониторЦелевыхПоказателей.Форма.ФормаМониторЦелевыхПоказателей", ПараметрыФормы, ЭтаФорма,
...
Процедура ЗарегистрироватьПостоянныеКоманды()
	...
	ПостоянныеКоманды.Добавить("СохранитьОфлайн");
	ПостоянныеКоманды.Добавить("СохранитьВсеОфлайн");
	ПостоянныеКоманды.Добавить("СписокОфлайнОтчетов");
...
&НаКлиенте
Процедура ОбновитьСоставМонитораКлиент(ПринудительноОбновитьДанные = Ложь, СохранитьОфлайнОтчет = Ложь)
...
Функция ОбновитьОфлайнОтчеты()
	...
	ПараметрыЗаполнения.Вставить("ОбновитьДашбордыМЦП", Истина);
