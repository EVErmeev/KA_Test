...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	ЗначениеВРеквизитФормы(
		Отчеты[СтрРазделить(ИмяФормы, ".")[1]].СформироватьПустоеДеревоСтраниц_2023(Объект.Организация, ДанныеОтчета),
		"ДеревоСтраниц");
КонецПроцедуры
...
Процедура ПоказатьТекущуюСтраницу(ИмяМакета, МногострочныеЧасти, ПредУИД)
	...
	ПоказатьМногострочныеЧасти(УведомлениеОСпецрежимахНалогообложения.ПолучитьМакетТабличногоДокумента(
		ЭтотОбъект, ИмяМакета), МногострочныеЧасти);
