...
Функция КадровыеДанныеСотрудника(ДанныеЭЛН, ГоловнаяОрганизация, ПредполагаемаяОрганизация = Неопределено) Экспорт
	...
	КонецЕсли;
	ИменаПолей = "Сотрудник, ФизическоеЛицо, ГоловнаяОрганизация, Организация, ДатаУвольнения, ВидЗанятости";
	...
	ПараметрыПолученияСотрудников.КадровыеДанные      = ИменаПолей;
	...
	Если Не КадровыеДанныеСотрудника.ЕстьПравоПросмотраОрганизации Тогда
		Результат.ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
