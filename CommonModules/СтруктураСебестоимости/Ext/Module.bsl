...
Процедура РазузловатьУзелДереваСебестоимости(ПараметрыДерева, ПараметрыУзла, ТаблицаРезультата, ОписаниеПродукции)
	...
	УчестьИзменениеСтоимостиПриХранении(ПараметрыДерева, ОписаниеПродукции, Результат);
	
КонецПроцедуры

Процедура УчестьИзменениеСтоимостиПриХранении(ПараметрыДерева, ОписаниеПродукции, Результат)
	...
	Если ПараметрыДерева.ТипРезультата = "ДеревоЗначений"
		...
		Для Каждого ТекСтрока Из Результат Цикл
			СуммаПоСтрокам = СуммаПоСтрокам + ТекСтрока.Сумма;
		КонецЦикла;
		
		Если Результат.Родитель <> Неопределено
			И СуммаПоСтрокам <> Результат.Родитель.Сумма
			Тогда
			...
			НоваяСтрока.Сумма = Результат.Родитель.Сумма - СуммаПоСтрокам;
