...
Функция РассчитатьНДСАвансыПолученныеПереносыПриход(ПараметрыРасчета)
	...
	|		И ДД.Контрагент = СчетаФактурыВыданныеАванс.Контрагент
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		ИсправленныеСчетаФактурыВыданныеАванс КАК ИсправленныеСчетаФактурыВыданныеАванс
	|	ПО
	...
	|		И ДД.Контрагент = ИсправленныеСчетаФактурыВыданныеАванс.Контрагент
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Функция РассчитатьНДСАвансыПолученныеЗачеты(ПараметрыРасчета)
	...
	Если ЗачетыАвансов.Количество()>0 Тогда
		...
		НачисленияСПолученногоАванса.Индексы.Добавить("ДокументОплаты, Контрагент, НаправлениеДеятельности, ОбъектРасчетов, Исправление, ДатаИсправления");
		...
		НачисленияСПолученногоАвансаИтоги.Свернуть("ДокументОплаты, Контрагент, ОбъектРасчетов, НаправлениеДеятельности, Исправление, ДатаИсправления");
