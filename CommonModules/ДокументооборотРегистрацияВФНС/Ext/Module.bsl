...
Функция СвойстваЗаявленияРегистрацииЮЛ(СсылкаПоиска) Экспорт
	...
	СписокПолей = "Организация, РегистрацияВИФНС, ПодписантТелефон, ВидУведомления";
	Если ТипЗнч(СсылкаПоиска) = Тип("СправочникСсылка.ОтправкиРегистрацияЮЛ") Тогда
		ДанныеЗаявления = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(СсылкаПоиска.ПредметОтправки, СписокПолей);
	Иначе
	...
	Результат.Вставить("КодНО", ?(ЗначениеЗаполнено(ДанныеЗаявления.РегистрацияВИФНС), ДанныеЗаявления.РегистрацияВИФНС.Код, ""));
	Результат.Вставить("ВидДокумента", ДанныеЗаявления.ВидУведомления);
	Результат.Вставить("Организация", ДанныеЗаявления.Организация);
	Результат.Вставить("ИНН", ?(ЗначениеЗаполнено(ДанныеЗаявления.Организация), ДанныеЗаявления.Организация.ИНН, ""));
	Результат.Вставить("НаименованиеОрганизации", ?(ЗначениеЗаполнено(ДанныеЗаявления.Организация), ДанныеЗаявления.Организация.Наименование, ""));
