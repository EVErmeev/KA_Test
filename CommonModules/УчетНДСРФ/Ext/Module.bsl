...
Функция РассчитатьНДСЗаписиКнигиПокупокПоАвансуПолученному(ПараметрыРасчета)
	...
	|		И НДСАвансыПолученныеЗачеты.Контрагент = СчетаФактурыВыданныеАванс.Контрагент
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	...
	|		И НДСАвансыПолученныеЗачеты.Контрагент = ИсправленныеСчетаФактурыВыданныеАванс.Контрагент
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
