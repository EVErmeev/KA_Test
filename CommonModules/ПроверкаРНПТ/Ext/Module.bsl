...
//
Процедура ЗаписатьСведенияОРНПТИзФНС(РНПТСсылка, СведенияОРНПТ, УдалитьЗапись = Ложь, ПолучитьСведенияИзСервиса = Ложь) Экспорт
...
Функция ЗначениеКонстантыИспользоватьПроверкуРНПТ() Экспорт
...
Процедура ИнициализироватьРеквизитыФормыДокумент(Форма)
	...
	ДобавитьРеквизитПроверкиРНПТ(Форма, "ИдентификаторЗадания",                  Новый УникальныйИдентификатор);
