...
//  Структура:
//   * ИдентификаторОборудования - СправочникСсылка.ПодключаемоеОборудование, Неопределено - ссылка на элемент подключаемого оборудования
...
//  Параметры - Структура:
//    * ОповещениеПриЗавершении - ОписаниеОповещения, Неопределено - Оповещение при завершении
...
// Возвращаемое значение:
//  Структура:
//   * КодОшибки - Строка - идентификатор ошибки при отправке.
...
//
// Параметры:
//  Вложения - Массив - массив структур содержащих вложения
...
Функция ФильтрСобытийЖурналаРегистрацииБПО()
	...
	События.Добавить(НСтр("ru = 'Обновление внешних компонент'"));
	События.Добавить(НСтр("ru = 'Добавление внешней компоненты'"));
	События.Добавить(НСтр("ru = 'Внешние компоненты'"));
	...
	События.Добавить(НСтр("ru = 'Диагностика соединения'"));
	События.Добавить(НСтр("ru = 'Получение файлов из Интернета'"));
	//@skip-check module-nstr-camelcase
	События.Добавить(НСтр("ru = 'Работа с почтовыми сообщениями.Отправка почты'"));
