...
Функция ЗарегистрироватьОбработку(Знач Объект, Знач ПараметрыРегистрации) Экспорт
	...
	Результат.Вставить("НазначениеВариантаОтчета", Перечисления.НазначенияВариантовОтчетов.ПустаяСсылка());
	...
	Если ЭтоВнешнийОтчет Тогда
		...
		Если РегистрационныеДанные.Свойство("НазначениеВариантаОтчета")
			И ЗначениеЗаполнено(РегистрационныеДанные.НазначениеВариантаОтчета) Тогда
			Результат.НазначениеВариантаОтчета = Перечисления.НазначенияВариантовОтчетов[РегистрационныеДанные.НазначениеВариантаОтчета];
		Иначе
			Результат.НазначениеВариантаОтчета = Перечисления.НазначенияВариантовОтчетов.НазначениеВариантаОтчетаПоУмолчанию();
		КонецЕсли;
	КонецЕсли;
