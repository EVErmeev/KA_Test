...
#Область ТекстНачислениеРезерва
	...
	|	0 КАК КоличествоДт,
	|	РезервыПредстоящихРасходов.СуммаНУ КАК СуммаНУДт,
	|	0 КАК СуммаПРДт,
	|	РезервыПредстоящихРасходов.СуммаРегл - РезервыПредстоящихРасходов.СуммаНУ КАК СуммаВРДт,
	|	
	...
	|	0 КАК КоличествоКт,
	|	РезервыПредстоящихРасходов.СуммаНУ КАК СуммаНУКт,
	|	0 КАК СуммаПРКт,
	|	РезервыПредстоящихРасходов.СуммаРегл - РезервыПредстоящихРасходов.СуммаНУ КАК СуммаВРКт,
...
#Область СписаниеРасходовЗаСчетРезервов //(Дт 96 :: Кт 25, 26)
	...
	|		И (ДД.СуммаРегл <> 0 ИЛИ ДД.СуммаУпр <> 0 ИЛИ ДД.ПостояннаяРазница <> 0 ИЛИ ДД.ВременнаяРазница <> 0)
	|
