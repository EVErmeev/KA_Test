...
Процедура ПроверитьЗаполнение_Раздел2(КонтекстВыполнения)
	...
	Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2023Кв1") Тогда
		...
		= "1011703, 1011705, 1011707, 1011709, 1011714, 1011715, 1011716, 1011717, 1011718, 1011719, 1011720, 1011721";
		...
		Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2023Кв1")
			...
			Если КодОперации <> "1011715" Тогда
				...
				Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2023Кв1") Тогда
					...
					ДолжноБытьЗаполненоНаименованиеПродавца = КодОперации = "1011721" ИЛИ КодОперации = "1011703";
