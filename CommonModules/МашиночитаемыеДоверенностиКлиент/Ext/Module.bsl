...
Процедура ДеревоОтбораПриАктивизацииСтроки(Элемент) Экспорт
	...
	Элемент.КонтекстноеМеню.ПодчиненныеЭлементы.ДеревоОтбораКонтекстноеМенюУдалить.Доступность = НЕ РазрешеноДобавление;
	Элемент.КоманднаяПанель.ПодчиненныеЭлементы.ДеревоОтбораУдалить.Доступность = НЕ РазрешеноДобавление;
...
Процедура ДеревоОтбораПередНачаломДобавления(ДеревоОтбора, Отказ, Элемент) Экспорт
	...
	Если ДанныеСтроки = Неопределено ИЛИ НЕ ДанныеСтроки.ДоступенСписок
		ИЛИ ДанныеСтроки.Тип = МашиночитаемыеДоверенностиКлиентСервер.Тип_Булево()
		ИЛИ ДанныеСтроки.Тип = МашиночитаемыеДоверенностиКлиентСервер.Тип_Число_15() Тогда
