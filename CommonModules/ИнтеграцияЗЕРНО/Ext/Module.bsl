...
Функция ПараметрыОптимизацииПоУмолчанию() Экспорт
	...
	ПараметрыОптимизации.Вставить("КоличествоЭлементовСтраницыОтвета",                  1000);
...
Функция ПакетыXDTO() Экспорт
	...
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_ws_types_1_0_3);
	
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_ws_faults_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_sdiz_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_lots_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_dictionaries_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_grainmonitor_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_sdiz_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_dictionary_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_organizations_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_common_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_lots_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_grainmonitor_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_commontypes_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_gpb_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_gpb_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_api_gpb_sdiz_1_0_3);
	ПакетыXDTO.Добавить(Метаданные.ПакетыXDTO.zerno_gpb_sdiz_1_0_3);
	
	ВозвращаемоеЗначение.Вставить("Список", ПакетыXDTO);
...
Процедура ПриДобавленииПараметровРаботыКлиента(Параметры) Экспорт
	...
	ИменаПараметров = ИнтеграцияЗЕРНОКлиентСерверПовтИсп.ИменаПараметровРаботыКлиентаВыборТипаПодписиБСП();
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры) Экспорт
	...
	Если ДанныеКлассификатра = Неопределено Тогда
		Возврат;
	КонецЕсли;
	...
	Исключение
		ТекстОшибки = СтрШаблон(
			...
			ДанныеКлассификатра.ВидКлассификатора,
	...
	МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоСсылке(ДанныеКлассификатра.ВидКлассификатора);
...
Функция ДанныеЗемельногоУчастка(ЗемельныйУчасток) Экспорт
	...
	ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ЗемельныйУчасток,
		"Адрес, АдресСтрокой, ПлощадьЗемельногоУчастка");
	...
	Данные.Вставить("ПлощадьЗемельногоУчастка", ЗначенияРеквизитов.ПлощадьЗемельногоУчастка);
