...
Процедура Подписать(НаборДанныхДляПодписания, Организация, ДоступныеСертификаты, ОповещениеПриЗавершении, СообщенияПослеПодписания = Неопределено, БезПодтверждения = Истина) Экспорт
	...
	Если ПараметрыРаботыКлиента[ИменаПараметров.ИмяПараметраПриложения] = ИменаПараметров.ЗначениеПараметраВыборТипаПодписиЗадаетсяПеречислением Тогда
		...
		МодульЭлектроннаяПодписьКлиент.Подписать(ОписаниеДанных, ФормаИлиИдентификатор, ПодписатьЗавершение, ТипПодписи);
	...
	Иначе
		...
		МодульЭлектроннаяПодписьКлиент.Подписать(ОписаниеДанных, ФормаИлиИдентификатор, ПодписатьЗавершение);
