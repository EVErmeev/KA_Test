...
Функция ДанныеРегистрационнойИнформации(ПараметрыРегистрации, ДанныеОператора, Ошибки)
	...
	Если ИнтеграцияЭДО.ЭтоФизЛицо(ПараметрыРегистрации.Организация) Тогда
		Если Не ПустаяСтрока(ПараметрыОрганизацииБЭД.Фамилия)
			...
			ОсновноеЛицоБезДоверенностиОтчество = ПараметрыОрганизацииБЭД.Отчество;
		КонецЕсли;
	КонецЕсли;
	...
	ФамилияБезПодчеркиванияИзСертификата = СтрЗаменить(ПараметрыСертификата.Фамилия, "_", " ");
	ИмяБезПодчеркиванияИзСертификата = СтрЗаменить(ПараметрыСертификата.Имя, "_", " ");
	ОтчествоБезПодчеркиванияИзСертификата = СтрЗаменить(ПараметрыСертификата.Отчество, "_", " ");
	
	ЗначенияРеквизитов.Вставить("Подписант.Должность",    ДолжностьПоСертификату);
	ЗначенияРеквизитов.Вставить("Подписант.ФИО.Фамилия",  ФамилияБезПодчеркиванияИзСертификата);
	ЗначенияРеквизитов.Вставить("Подписант.ФИО.Имя",      ИмяБезПодчеркиванияИзСертификата);
	ЗначенияРеквизитов.Вставить("Подписант.ФИО.Отчество", ОтчествоБезПодчеркиванияИзСертификата);
