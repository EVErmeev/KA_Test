...
//
Процедура ПоказатьСправкуПоФорматуПДФ_А3_ЗапроситьФайл(ОписаниеОповещенияОЗавершении) Экспорт
...
// 
// Возвращаемое значение:
//  Структура - см. НовыйПараметрыПриложенияПриложенияПДФ_А3
//
Функция ПараметрыПриложенияПДФ_А3() Экспорт
