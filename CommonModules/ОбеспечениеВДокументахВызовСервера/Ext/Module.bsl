...
//
Функция ПараметрыВыбораОбеспечения(ФормаСтруктурой, ТекущаяСтрока, Режим) Экспорт
	
	Возврат ОбеспечениеВДокументахСервер.ПараметрыВыбораОбеспечения(ФормаСтруктурой, ТекущаяСтрока, Режим);
