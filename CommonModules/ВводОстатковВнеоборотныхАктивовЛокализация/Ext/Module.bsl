...
Процедура ФормаРедактированияСтрокиОС_ПорядокУчетаБУПриИзменении(Форма) Экспорт

	//++ Локализация
	
	ФормаРедактированияСтрокиОС_ЗаполнитьГодовуюНормуАмортизацииБУ(Форма);
	
	ИзмененныеРеквизиты = ВнеоборотныеАктивыКлиентСервер.ПриИзмененииПорядкаУчетаБУ_ОС(
								Форма, Форма.ВспомогательныеРеквизиты);
