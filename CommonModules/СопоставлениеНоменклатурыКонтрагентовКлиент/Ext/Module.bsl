...
//											  По умолчанию используется значение определяемого типа НоменклатураБЭД
//   * ОтключитьПоискПоНатуральнымКлючам    - Булево - признак отключения поиска соотвествий по натуральным ключам. По умолчанию Ложь.
...
//   * ВидимостьКолонокСопоставления        - Структура, см. СопоставлениеНоменклатурыКонтрагентовКлиентСервер.НовыеНастройкиВидимостиКолонокСопоставления().
//   * ДополнительныеРеквизитыСопоставления - Массив структур см. СопоставлениеНоменклатурыКонтрагентовКлиентСервер.НовыйДополнительныйРеквизитСопоставления().
