...
// см. УчетНДСУП.НалогообложенияПродажНДСНеУчитываетсяВСтоимости
...
#Область ЗаполнениеТоваровСФВыданныйПеревыставление
	...
	|	МАКСИМУМ(СчетФактураПолученныйДокументыОснования.ИсходныйДокумент.Дата) КАК ДатаИсходногоДокумента,
	|	СчетФактураПолученныйДокументыОснования.ДокументОснование КАК ДокументОснование
	|ПОМЕСТИТЬ втСчетФактураПолученныйДатаИсходногоДокумента
	|ИЗ
	...
	|	
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	втСчетФактураПолученныйДатаИсходногоДокумента.Ссылка КАК Ссылка,
	|	ЕСТЬNULL(СчетФактураПолученныйДокументыОснования.ИсходныйДокумент, ЗНАЧЕНИЕ(Документ.СчетФактураПолученный.ПустаяСсылка)) КАК ИсходныйДокумент,
	|	втСчетФактураПолученныйДатаИсходногоДокумента.ДокументОснование КАК ДокументОснование
	|ПОМЕСТИТЬ втСчетФактураПолученныйДокументыОснования
	|ИЗ 
	|	втСчетФактураПолученныйДатаИсходногоДокумента КАК втСчетФактураПолученныйДатаИсходногоДокумента
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СчетФактураПолученный.ДокументыОснования КАК СчетФактураПолученныйДокументыОснования
	|			ПО СчетФактураПолученныйДокументыОснования.Ссылка = втСчетФактураПолученныйДатаИсходногоДокумента.Ссылка
	|				И СчетФактураПолученныйДокументыОснования.ИсходныйДокумент.Дата = втСчетФактураПолученныйДатаИсходногоДокумента.ДатаИсходногоДокумента
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|	
