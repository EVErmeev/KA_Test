...
//    * ПараметрыЭквайринговойОперации - См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыПакетнойОперацииВОчередиЧеков - структура для передачи данных в пакетной операции
//    * ПараметрыПродажаСВыдачейНаличных - См. ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыПакетнойОперацииВОчередиЧеков - структура для передачи данных в пакетной операции
//
