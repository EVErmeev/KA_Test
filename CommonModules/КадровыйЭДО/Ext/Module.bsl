...
//		ОтветственныеЛицаОрганизации - Структура - см. ЗарплатаКадры.ОтветственныеЛицаОрганизации.
//	Возвращаемое значение:
