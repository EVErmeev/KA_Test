...
Функция ТекстВтНезавершенноеПроизводство() Экспорт
	...
	|	ЕСТЬNULL(Доли.СтатьяКалькуляции, ДД.СтатьяКалькуляции) КАК СтатьяКалькуляции,
	|	ЗНАЧЕНИЕ(Справочник.ЭтапыПроизводства.ПустаяСсылка)        КАК Этап,
	|	ЕСТЬNULL(Доли.ГруппаПродукции, ДД.ГруппаПродукции) КАК ГруппаПродукции,
	|	ЕСТЬNULL(Доли.ПравилоОтнесенияНаВыпуск, ДД.ПравилоОтнесенияНаВыпуск) КАК ПравилоОтнесенияНаВыпуск,
	...
	|	ДД.КорНаправлениеДеятельности,
	|	ЕСТЬNULL(Доли.СтатьяКалькуляции, ДД.СтатьяКалькуляции),
	|	ЕСТЬNULL(Доли.ГруппаПродукции, ДД.ГруппаПродукции),
	|	ЕСТЬNULL(Доли.ПравилоОтнесенияНаВыпуск, ДД.ПравилоОтнесенияНаВыпуск)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	//-- Локализация
	...
	|	 - ЕСТЬNULL(СуммыРасходовРегл.ВременнаяРазница, 0) 			КАК СуммаНУ,
	|	ВЫБОР
	...
	|				)
	|			ТОГДА СуммыРасходовРегл.ПостояннаяРазница
	|		ИНАЧЕ
	|			0
