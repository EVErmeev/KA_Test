...
Функция УдалитьДокументИзПакета(ИдентификаторПакета, ЭлектронныйДокумент, КонтекстДиагностики = Неопределено) Экспорт
	...
	Попытка
		...
		СостоянияДокументовЭДО = ЭлектронныеДокументыЭДО.СостоянияДокументов(ДокументыПакета);
...
Функция СостоянияДокументовПакета(ИдентификаторПакета) Экспорт
	...
	СостоянияДокументовЭДО = ОбщегоНазначения.ВыгрузитьКолонку(СостоянияПоДокументам, "Значение");
...
// Параметры:
//  СостоянияДокументов - см. СостоянияДокументовПакета
// 
// Возвращаемое значение:
...
Функция СостояниеПакета(СостоянияДокументов) Экспорт
	...
	Возврат СводноеСостояниеПакета(СостоянияДокументов);
...
//  Булево
//
Функция ДоступноИзменениеПакета(СостоянияДокументов) Экспорт
	
	Результат = Истина;
	
	Для Каждого Состояние Из СостоянияДокументов Цикл
...
// Параметры:
//  СостоянияДокументов - Соответствие из КлючИЗначение:
