...
Функция СписокАвтоподбораПолеСоставногоТипа(ОписаниеТипов, ТекстДляАвтоПодбора,
	...
	Если СтрДлина(ТекстДляАвтоПодбора) >= МинимальнаяДлинаСтрокиПоиска Тогда
		...
		|;
		|%2",
		ТекстЗапросаСпискаАвтоподбораПоляСоставногоТипа(ОписаниеТипов, ПустаяСтрока(ТекстДляАвтоПодбора), "ТаблицаАвтоподбора"),
		"ВЫБРАТЬ
		...
		ОписаниеМетаданных = ОписаниеМетаданныхПоОписаниюТипов(ОписаниеТипов);
