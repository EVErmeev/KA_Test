...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПредставлениеЛожь = Нстр("ru='Десктоп'");
...
Процедура ПослеОбновленияОфлайнОтчетов(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Ошибка" Тогда
		ТекстСообщения = НСтр("ru = 'Произошла ошибка обновления офлайн-отчетов:'") + Символы.ПС + Результат.КраткоеПредставлениеОшибки;
	Иначе
...
Процедура ОпределитьПоведениеВМобильномКлиенте()
	...
	Элементы.Переместить(Элементы.ОтображатьВсеВариантыОтчетов, Элементы.ВерхняяПанельМобильныйКлиент, Элементы.ПоказыватьПодсказки);
	Элементы.ОтображатьВсеВариантыОтчетов.Заголовок = НСтр("ru = 'Отображать для десктопа'");
...
Функция ЗаполнитьПанельОтчетовВФоне()
	...
	Если Не ОтображатьВсеВариантыОтчетов Тогда
		НазначенияВариантовОтчетов = Новый Массив;
		НазначенияВариантовОтчетов.Добавить(Перечисления.НазначенияВариантовОтчетов.Везде);
		НазначенияВариантовОтчетов.Добавить(?(ОбщегоНазначения.ЭтоМобильныйКлиент(),
									Перечисления.НазначенияВариантовОтчетов.МобильныйКлиент,
									Перечисления.НазначенияВариантовОтчетов.Десктоп));
