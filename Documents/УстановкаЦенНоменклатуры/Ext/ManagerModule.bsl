...
Функция ТекстЗапросаПереоценкиТоваровВРозницеБДПоАссортименту2_5()
	...
	|			ПО УстановкаЦенТоварыАссортимент.ХарактеристикаЦО <> ЗНАЧЕНИЕ(Справочник.ХарактеристикиНоменклатурыДляЦенообразования.ПустаяСсылка)
	|			И
	|				УстановкаЦенТоварыАссортимент.ХарактеристикаЦО = ХарактеристикиНоменклатуры.ХарактеристикаНоменклатурыДляЦенообразования
...
Функция ДанныеДляПечатиЭтикетокИлиЦенников(МассивДокументов, ПараметрыПечати)
	...
	Если ИспользуетсяЦенообразование25 Тогда
		...
		|	ЦеныНоменклатурыПредв.Количество
		|ИЗ
	...
	ТаблицаРеквизитыДокументов = МассивРезультатов[1 + ИтераторСдвига].Выгрузить();
	...
	СтруктураРезультат.Вставить("Товары", МассивРезультатов[ИтераторСдвига].Выгрузить());
