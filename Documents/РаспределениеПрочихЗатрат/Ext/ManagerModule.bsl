...
Функция РаспределитьРасходыНаФинансовыйРезультат(Период, Организации, МенеджерВременныхТаблиц = Неопределено, ДокументРаспределения = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		//////////////////////////////////////////////////////////////////////
		// ВТ СписаниеНУ:
		// списание без распределения по НД сумм ПР и ВР, связанные с НУ
		//////////////////////////////////////////////////////////////////////
		
		//////////////////////////////////////////////////////////////////////
		// Нормируемые расходы всегда списываются в НУ
		// без распределения по НД по отдельной ХО
		//////////////////////////////////////////////////////////////////////
		
		|ВЫБРАТЬ //**01 - при выкл. ФО ИспользоватьРеглУчет отключаем выборку
		...
		// К списанию без распределения по НД
		// ПР и ВР по документам распределеия с отражением только в НУ
		...
		// ОВЗ: Нормируемые расходы всегда списываются в НУ
		// без распределения по НД по отдельной ХО
		...
		// ОВЗ: К списанию без распределения по НД
		// ПР и ВР по документам распределеия с отражением только в НУ
		...
		|
		//////////////////////////////////////////////////////////////////////
		// ВТ РасходыКРаспределению:
		// формирование остатков к распределению по НД
		//////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		//////////////////////////////////////////////////////////////////////
		// К распределению суммы ПР и ВР, связанные с БУ и/или НУ
		// при совместном распределении
		//////////////////////////////////////////////////////////////////////
		...
		|	+ ВЫБОР
		// если не распределяется в НУ 
		|		КОГДА НЕ Регистраторы.НалоговыйУчет ИЛИ НЕ 
		|			ИсточникНастроек.ВариантРаспределенияРасходовНУ = 
		|				ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаНаправленияДеятельности)
		|			ТОГДА 0
		// по НУ при (БУ = 0) 
		|		КОГДА ОстаткиРасходов.СуммаРегл = 0
	...
	Если НЕ ИспользоватьРеглУчет Тогда
		...
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "//**01", "ПЕРВЫЕ 0 //"); //@Query-part
