...
Процедура ПрочиеРасходыСуммаРеглПриИзменении(Элемент)
	...
	Если Не СтрокаТаблицы.ПринятиеКНалоговомуУчету Тогда
...
&НаСервере
Процедура ЗаполнитьРеквизитыВТабличнойЧасти(НомерСтроки = Неопределено)
	...
	ЗаполнитьЗависимыеРеквизитыТЧ(Объект.ПрочиеРасходы, СтатьиРасходовТЧ, НомерСтроки);
...
//
&НаСервере
Процедура ЗаполнитьЗависимыеРеквизитыТЧ(ТаблицаФормы, РеквизитыТЧ, НомерСтроки = Неопределено)
	...
	Если НомерСтроки <> Неопределено Тогда
		Строки = Новый Массив();
		Строки.Добавить(ТаблицаФормы[НомерСтроки]);
	КонецЕсли;
