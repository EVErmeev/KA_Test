...
Процедура ОбработатьУказаниеНомераГТДСервер(ИдентификаторСтроки,
	...
	Если ИспользуетсяКоличествоУпаковок Тогда
		...
		ДобавитьВСтруктуруДействияПриИзмененииКоличестваУпаковок(ДействияОбработки, ЭтотОбъект, "После");
	Иначе
		ДобавитьВСтруктуруДействияПриИзмененииКоличества(ДействияОбработки, ЭтотОбъект);
		ДобавитьВСтруктуруДействияПриИзмененииКоличества(ДействияОбработки, ЭтотОбъект, "После");
	КонецЕсли;
