...
Процедура ОбновитьЭлементыШапки()
	...
	Элементы.ГруппаКодСтраныГражданства.Видимость    = ЧислитсяВОрганизации;
	...
	Если Объект.Пол = Перечисления.ПолФизическогоЛица.Женский Тогда
		Элементы.НеЧислилсяВОрганизации.Заголовок = НСтр("ru = 'Не числилась в организации'");
	Иначе
		Элементы.НеЧислилсяВОрганизации.Заголовок = "";
	КонецЕсли;
КонецПроцедуры
