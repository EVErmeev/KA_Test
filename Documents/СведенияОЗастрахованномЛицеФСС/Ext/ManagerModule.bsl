...
Процедура ЗарегистрироватьРезультатыОтправки(СтрокаОтправки, Измененные) Экспорт
	...
	// Затем записывается транспортный документ.
	...
	// Затем обновляется регистр.
	РегистрыСведений.СведенияОЗастрахованныхЛицахФСС.ПриЗаписиРегистрацииСведений(РегистрацияОбъект, ОтправленныйОбъект);
