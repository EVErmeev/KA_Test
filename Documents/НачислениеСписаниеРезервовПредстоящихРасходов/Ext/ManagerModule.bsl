...
Функция ТекстЗапросаТаблицаВтНачисления(Запрос, ТекстыЗапроса)
	...
	|		ТОГДА Строки.НоваяСуммаРегл - Строки.ТекущаяСуммаРегл
	|		КОГДА Строки.УстановитьНовуюСуммуНУ И Строки.ТекущаяСуммаНУ < Строки.НоваяСуммаНУ
	...
	|	ИЛИ Строки.УстановитьНовуюСуммуНУ И Строки.ТекущаяСуммаНУ < Строки.НоваяСуммаНУ)";
...
Процедура ТекстЗапросаПрочиеДоходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|ГДЕ
	|	ТаблицаСписаний.СуммаРегл <> 0 ИЛИ ТаблицаСписаний.СуммаУпр <> 0
	|
	|СГРУППИРОВАТЬ ПО
