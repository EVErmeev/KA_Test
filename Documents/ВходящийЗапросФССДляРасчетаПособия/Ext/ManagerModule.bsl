...
Процедура ЗагрузитьСообщение100(Страхователь, ИдентификаторСообщения, ТекстXML, ТребуетсяПодтверждение, Результат) Экспорт
	УстановитьПривилегированныйРежим(Истина);
...
Функция МаксимальнаяДатаОтвета(Объект) Экспорт
	...
	КонецЕсли;
	Возврат СЭДОФСС.БлижайшийРабочийДень(ДатаОтсчета, РабочихДнейНаОтправкуОтвета());
КонецФункции
