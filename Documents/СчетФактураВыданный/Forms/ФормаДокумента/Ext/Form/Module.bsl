...
Процедура ТоварыМежценоваяРазницаПриИзменении(Элемент)
	...
	Если Объект.НДССМежценовойРазницы Тогда 
		...
		ТекущаяСтрока.СуммаНДС = Окр(ТекущаяСтрока.МежценоваяРазница * УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС) / 100, 2, РежимОкругления.Окр15как20);
...
Процедура ТоварыМежценоваяРазницаУвеличениеПриИзменении(Элемент)
	...
	Если Объект.НДССМежценовойРазницы Тогда 
		...
		ТекущаяСтрока.СуммаНДСУвеличение = Окр(ТекущаяСтрока.МежценоваяРазницаУвеличение* УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС) / 100, 2, РежимОкругления.Окр15как20);
...
Процедура ТоварыМежценоваяРазницаУменьшениеПриИзменении(Элемент)
	...
	Если Объект.НДССМежценовойРазницы Тогда 
		...
		ТекущаяСтрока.СуммаНДСУменьшение = Окр(ТекущаяСтрока.МежценоваяРазницаУменьшение * УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС) / 100, 2, РежимОкругления.Окр15как20);
...
Процедура ТоварыСтавкаНДСПриИзменении(Элемент)
	...
	Если Объект.НДССМежценовойРазницы Тогда 
		...
		ТекущаяСтрока.СуммаНДС = Окр(ТекущаяСтрока.МежценоваяРазница * ЗначениеСтавкиНДС / 100, 2, РежимОкругления.Окр15как20);
		ТекущаяСтрока.СуммаНДСУвеличение = Окр(ТекущаяСтрока.МежценоваяРазницаУвеличение* ЗначениеСтавкиНДС / 100, 2, РежимОкругления.Окр15как20);
		ТекущаяСтрока.СуммаНДСУменьшение = Окр(ТекущаяСтрока.МежценоваяРазницаУменьшение * ЗначениеСтавкиНДС / 100, 2, РежимОкругления.Окр15как20);
...
Процедура ТоварыСуммаНДСПриИзменении(Элемент)
	...
	Если Объект.НДССМежценовойРазницы Тогда 
		...
		ТекущаяСтрока = Элементы.Товары.ТекущиеДанные;
		ЗначениеСтавкиНДС = УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС);
		ТекущаяСтрока.МежценоваяРазница = Окр(?(ЗначениеСтавкиНДС = 0, 0, 100 * ТекущаяСтрока.СуммаНДС / ЗначениеСтавкиНДС), 2, РежимОкругления.Окр15как20);
...
&НаКлиенте
Процедура ТоварыСуммаНДСУвеличениеПриИзменении(Элемент)

	Если Объект.НДССМежценовойРазницы Тогда 
		
		ТекущаяСтрока = Элементы.Товары.ТекущиеДанные;
		ЗначениеСтавкиНДС = УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС);
		ТекущаяСтрока.МежценоваяРазницаУвеличение = Окр(?(ЗначениеСтавкиНДС = 0, 0, 100 * ТекущаяСтрока.СуммаНДСУвеличение / ЗначениеСтавкиНДС), 2, РежимОкругления.Окр15как20);
...
&НаКлиенте
Процедура ТоварыСуммаНДСУменьшениеПриИзменении(Элемент)

	Если Объект.НДССМежценовойРазницы Тогда 
		
		ТекущаяСтрока = Элементы.Товары.ТекущиеДанные;
		ЗначениеСтавкиНДС = УчетНДСУПКлиентСервер.ЗначениеСтавкиНДС(ТекущаяСтрока.СтавкаНДС);
		ТекущаяСтрока.МежценоваяРазницаУменьшение = Окр(?(ЗначениеСтавкиНДС = 0, 0, 100 * ТекущаяСтрока.СуммаНДСУменьшение / ЗначениеСтавкиНДС), 2, РежимОкругления.Окр15как20);
