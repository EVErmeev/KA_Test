...
Процедура ОбновитьРеквизитыТранспортныхНакладныхПриЗаписиЗаданияНаПеревозку(ЗаданиеНаПеревозкуОбъект) Экспорт
	...
	|ПОМЕСТИТЬ ТранспортнаяНакладнаяДокументыОснования
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВложенныйЗапрос.ТранспортнаяНакладная КАК ТранспортнаяНакладная,
	|	МИНИМУМ(ВложенныйЗапрос.НомерСтрокиМаршрута) КАК НомерСтрокиМаршрута
	|ПОМЕСТИТЬ ТранспортныеНакладныеПоМаршрутам
	|ИЗ
	|	(ВЫБРАТЬ
	|		МИНИМУМ(ТранспортнаяНакладнаяДокументыОснования.ТранспортнаяНакладная) КАК ТранспортнаяНакладная,
	|		НакладныеПоЗаданиямНаПеревозку.НомерСтрокиМаршрута КАК НомерСтрокиМаршрута
	|	ИЗ
	|		ТранспортнаяНакладнаяДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	...
	|	
	|	СГРУППИРОВАТЬ ПО
	|		НакладныеПоЗаданиямНаПеревозку.НомерСтрокиМаршрута) КАК ВложенныйЗапрос
	|
	|СГРУППИРОВАТЬ ПО
	|	ВложенныйЗапрос.ТранспортнаяНакладная
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТранспортныеНакладныеПоМаршрутам.ТранспортнаяНакладная КАК ТранспортнаяНакладная,
	|	ТранспортныеНакладныеПоМаршрутам.НомерСтрокиМаршрута КАК НомерСтрокиМаршрута,
	|	НакладныеПоЗаданиямНаПеревозку.ЗаданиеНаПеревозку КАК ЗаданиеНаПеревозку,
	|	НакладныеПоЗаданиямНаПеревозку.Накладная КАК Накладная
	|ПОМЕСТИТЬ ЗаполненныеТранспортныеНакладные
	|ИЗ
	|	ТранспортныеНакладныеПоМаршрутам КАК ТранспортныеНакладныеПоМаршрутам
	|		ЛЕВОЕ СОЕДИНЕНИЕ НакладныеПоЗаданиямНаПеревозку КАК НакладныеПоЗаданиямНаПеревозку
	|		ПО ТранспортныеНакладныеПоМаршрутам.НомерСтрокиМаршрута = НакладныеПоЗаданиямНаПеревозку.НомерСтрокиМаршрута
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЕСТЬNULL(ЗаполненныеТранспортныеНакладные.ТранспортнаяНакладная, ТранспортнаяНакладнаяДокументыОснования.ТранспортнаяНакладная) КАК Ссылка,
	|	ЕСТЬNULL(ТранспортнаяНакладнаяДокументыОснования.ДокументОснование, НЕОПРЕДЕЛЕНО) КАК ДокументОснованиеУдалить,
	|	ЕСТЬNULL(ЗаполненныеТранспортныеНакладные.Накладная, НЕОПРЕДЕЛЕНО) КАК ДокументОснованиеДобавить
	|ИЗ
	|	ЗаполненныеТранспортныеНакладные КАК ЗаполненныеТранспортныеНакладные
	|		ПОЛНОЕ СОЕДИНЕНИЕ ТранспортнаяНакладнаяДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|		ПО ЗаполненныеТранспортныеНакладные.ТранспортнаяНакладная = ТранспортнаяНакладнаяДокументыОснования.ТранспортнаяНакладная
	|			И ЗаполненныеТранспортныеНакладные.Накладная = ТранспортнаяНакладнаяДокументыОснования.ДокументОснование
	|ГДЕ
	|	(ЗаполненныеТранспортныеНакладные.Накладная ЕСТЬ NULL
	|			ИЛИ ТранспортнаяНакладнаяДокументыОснования.ДокументОснование ЕСТЬ NULL)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Выборка.ДокументОснованиеУдалить) Тогда

			СтрокаДокументаОснования = ТекущаяТранспортнаяНакладная.ДокументыОснования.Найти(Выборка.ДокументОснованиеУдалить, "ДокументОснование");
		...
		ИначеЕсли ЗначениеЗаполнено(Выборка.ДокументОснованиеДобавить) Тогда

			СтрокаДокументаОснования = ТекущаяТранспортнаяНакладная.ДокументыОснования.Добавить();

			СтрокаДокументаОснования.ДокументОснование = Выборка.ДокументОснованиеДобавить;
			ТранспортнаяНакладнаяИзменена = Истина;
