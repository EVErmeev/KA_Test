...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.ВариантФормированияАТКИСМП.Видимость     = ЭтоИмпортСФТС И Не ЭтоМех И Не ЭтоПиво;
	...
	ИначеЕсли ВозможнаОперацияНанесения Тогда
		...
		Если ЭтоМолочнаяПродукция Или ЭтоБАД Или ЭтоПиво Или ЭтоБАПиво Или ЭтоУпакованнаяВода Тогда
...
Процедура ЗаполнитьДоступныеВариантыЗаполненияДекларации(Форма)
	...
	Если Объект.ВидПродукции <> ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво") Тогда
...
Процедура ОпределитьФорматРедактированияСрокГодности()
	...
	ИначеЕсли Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы")
		Или Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво")
		Или Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БезалкогольноеПиво")
		Или Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.УпакованнаяВода") Тогда
		ФорматДаты = "ДФ=dd.MM.yyyy;";
		Элементы.ТоварыСрокГодности.ФорматРедактирования = ФорматДаты;
	Иначе
...
Процедура УстановитьФорматСрокГодности(Форма)
	...
	ИначеЕсли Форма.Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БАДы")
		Или Форма.Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.Пиво")
		Или Форма.Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.БезалкогольноеПиво")
		Или Форма.Объект.ВидПродукции = ПредопределенноеЗначение("Перечисление.ВидыПродукцииИС.УпакованнаяВода") Тогда
		ФорматДаты = "ДФ=dd.MM.yyyy;";
		Форма.Элементы.СрокГодности.Формат               = ФорматДаты;
		Форма.Элементы.СрокГодности.ФорматРедактирования = ФорматДаты;
	Иначе
