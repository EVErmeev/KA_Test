...
Функция ЗаполнитьМЧД(МЧД, Сведения) Экспорт
	...
	Попытка
		...
		ДанныеДоверенности =
			МашиночитаемыеДоверенности.ДанныеИзФайлаОбмена(ДанныеДляЗагрузки.ДанныеДоверенности);
...
//  					- Структура см. МашиночитаемыеДоверенностиКлиентСервер.НовыеДанныеДляПроверкиМЧД
//
Функция ЗагрузитьМЧДИзФайла(ДанныеФайла, МЧД = Неопределено) Экспорт
	...
	Попытка
		МашиночитаемыеДоверенности.ПрочитатьДанныеXML(ДанныеДляЗагрузки.ДанныеДоверенности);
	Исключение
