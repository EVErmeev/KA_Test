...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитыВидаПлана = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ВидПлана, "ТипПлана, Владелец, КоличествоПериодов, Периодичность");
...
Функция ПараметрыПреобразованияКроссТаблицы()
	...
	ПоляГруппировки = ПоляГруппировки + ", Характеристика, Назначение, Упаковка, Склад";
