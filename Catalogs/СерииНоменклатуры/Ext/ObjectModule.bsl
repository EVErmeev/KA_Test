...
Процедура ПередЗаписью(Отказ)
	...
	Если УстановитьРеквизитыЦенообразования 
		И ЗначениеЗаполнено(НастройкиИспользованияСерий.НастройкиКлючаЦенПоСерии) Тогда
		...
		Если Не ОбновлениеНастроекЦенообразованияВидыНоменклатуры Тогда
			...
			ИначеЕсли НастройкиИспользованияСерий.НастройкиКлючаЦенПоСерии = Перечисления.ВариантОтбораДляКлючаЦен.Использовать Тогда
