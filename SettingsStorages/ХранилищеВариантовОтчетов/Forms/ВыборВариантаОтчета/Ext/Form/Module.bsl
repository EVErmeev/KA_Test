...
Процедура ЗаполнитьСписокВариантов()
	...
	Для Каждого СведенияОВарианте Из ТаблицаВариантов Цикл
		...
		Если СведенияОВарианте.Назначение = Перечисления.НазначенияВариантовОтчетов.МобильныйКлиент Тогда
			Вариант.КартинкаНазначение = 0;
		ИначеЕсли СведенияОВарианте.Назначение = Перечисления.НазначенияВариантовОтчетов.Десктоп Тогда
			Вариант.КартинкаНазначение = 1;
		ИначеЕсли СведенияОВарианте.Назначение = Перечисления.НазначенияВариантовОтчетов.Везде Тогда
