...
Процедура Зарегистрироваться(Команда)
	...
	Если Не Отказ Тогда  
		...
		КонецЕсли;
		ДокументооборотСРЭЦКлиент.РегистрацияВСервисе(Логин, Пароль, Организация, Сертификат, ПараметрыДляСледующихШагов, ОбработкаОповещения, УникальныйИдентификатор);
	КонецЕсли;
