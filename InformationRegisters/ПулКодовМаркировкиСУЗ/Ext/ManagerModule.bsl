...
Процедура РаспечататьЭтикеткиИЗафиксироватьДатуПечати(
	...
	Иначе
		СтруктураОбъектовПечати = Неопределено;
	КонецЕсли;
	
	Если СтруктураОбъектовПечати = Неопределено Тогда
...
Процедура РаспечататьЭтикеткиИЗафиксироватьДатуПечатиДляОбъектовПечати(ДанныеПечати, СтруктураОбъектовПечати,
	...
	Попытка
		...
		Если ДанныеПечати.Свойство("ДополнитьПолныйКодМаркировки")
				И ДанныеПечати.ДополнитьПолныйКодМаркировки = "3103"
			Или СтруктураОбъектовПечати.Свойство("ДополнитьПолныйКодМаркировки")
				И СтруктураОбъектовПечати.ДополнитьПолныйКодМаркировки = "3103" Тогда
			...
			Для Каждого СтрокаТЧ Из ОбщаяТаблицаПечати Цикл
				...
				КонецЕсли;
			КонецЦикла;
		ИначеЕсли ДанныеПечати.Свойство("ДополнитьПолныйКодМаркировки")
				И ДанныеПечати.ДополнитьПолныйКодМаркировки = "3353"
			Или СтруктураОбъектовПечати.Свойство("ДополнитьПолныйКодМаркировки")
				И СтруктураОбъектовПечати.ДополнитьПолныйКодМаркировки = "3353" Тогда
			ОбщаяТаблицаПечати.Колонки.Добавить("ПолныйКодМаркировкиИзменен", Новый ОписаниеТипов("Булево"));
			РазделительGS = РазборКодаМаркировкиИССлужебныйКлиентСервер.РазделительGS();
