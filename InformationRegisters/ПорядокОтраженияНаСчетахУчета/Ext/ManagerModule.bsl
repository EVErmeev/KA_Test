...
Функция СписокСчетовУчетаПоРазделуУчета(РазделУчета) Экспорт
	...
	Если РазделУчета = "НоменклатураСобственная" Или РазделУчета = "Номенклатура" Тогда
		...
		Если ИспользуетсяЕНВД Тогда
			СчетаУчетаРегл.Добавить("ВыручкаОтПродаж", НСтр("ru = 'Выручки (ОСНО)'"), Истина);
			СчетаУчетаРегл.Добавить("ВыручкаОтПродажЕНВД", НСтр("ru = 'Выручки (ЕНВД)'"), Истина);
			СчетаУчетаРегл.Добавить("СебестоимостьПродаж", НСтр("ru = 'Себестоимости (ОСНО)'"), Истина);
			СчетаУчетаРегл.Добавить("СебестоимостьПродажЕНВД", НСтр("ru = 'Себестоимости (ЕНВД)'"), Истина);
		Иначе
			СчетаУчетаРегл.Добавить("ВыручкаОтПродаж", НСтр("ru = 'Выручки'"), Истина);
			СчетаУчетаРегл.Добавить("ВыручкаОтПродажЕНВД", НСтр("ru = 'Выручки (ЕНВД)'"), Ложь);
			СчетаУчетаРегл.Добавить("СебестоимостьПродаж", НСтр("ru = 'Себестоимости'"), Истина);
			СчетаУчетаРегл.Добавить("СебестоимостьПродажЕНВД", НСтр("ru = 'Себестоимости (ЕНВД)'"), Ложь);
		КонецЕсли;
...
Функция ЭлементыНастройкиСчетовУчетаПоРазделуУчета(РазделУчета) Экспорт
	...
	Если РазделУчета = "НоменклатураСобственная" Или РазделУчета = "Номенклатура" Тогда
		...
		Если ИспользуетсяЕНВД Тогда
			...
			СчетаУчетаРегл.Вставить(2, "Субконто_ВыручкаОтПродаж", НСтр("ru = 'Статья учета выручки (ОСНО)'"), Истина);
			СчетаУчетаРегл.Добавить("Субконто_ВыручкаОтПродажЕНВД", НСтр("ru = 'Статья учета выручки (ЕНВД)'"), Истина);
			СчетаУчетаРегл.Добавить("Субконто_СебестоимостьПродаж", НСтр("ru = 'Статья учета себестоимости (ОСНО)'"), Истина);
			СчетаУчетаРегл.Добавить("Субконто_СебестоимостьПродажЕНВД", НСтр("ru = 'Статья учета себестоимости (ЕНВД)'"), Истина);
		Иначе
			// Первое из субконто не добавляем, а вставляем, чтобы группа субконто примыкала к группе счетов продаж:
			СчетаУчетаРегл.Вставить(2, "Субконто_ВыручкаОтПродаж", НСтр("ru = 'Статья учета выручки'"), Истина);
			СчетаУчетаРегл.Добавить("Субконто_ВыручкаОтПродажЕНВД", НСтр("ru = 'Статья учета выручки (ЕНВД)'"), Ложь);
			СчетаУчетаРегл.Добавить("Субконто_СебестоимостьПродаж", НСтр("ru = 'Статья учета себестоимости'"), Истина);
			СчетаУчетаРегл.Добавить("Субконто_СебестоимостьПродажЕНВД", НСтр("ru = 'Статья учета себестоимости (ЕНВД)'"), Ложь);
		КонецЕсли;
