...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		Если ТипЗнч(Запись.Физлицо) = Тип("СправочникСсылка.ФизическиеЛица") Тогда
			МассивЗаписей.Добавить(Запись);
		КонецЕсли;
	КонецЦикла;
	УчетПособийСоциальногоСтрахования.ПриЗаписиРегистраДокументыФизическихЛиц(МассивЗаписей, Отказ, Замещение);
	//-- НЕ УТ
